...
class PatientAPI extends React.Component {
    ...
    //     return this.state.patientJournals;
    // }
    ...
    static ReturnSingelPatientJournal(id) {
        return this.state.patientJournals.filter(patientJournal => patientJournal.patientJournal.id == id);
    }
