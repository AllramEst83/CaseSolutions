const patientJournals = [
  {
    patientJournal: {
      ...
      clinic: clinics[0].clinicTwo,
      doctors: [doctors[0].doctorTwo],
      medicalServices: medicalServices[0].medicalServiceOne,
      owners: owners[0].ownerTwo
    },
    statusCode: 200,
    error: "No error",
